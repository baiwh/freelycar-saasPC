        ...
        <el-table-column label="操作" width="230" align="center">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" v-show="scope.row.state === 1"
                       @click="serviceFinish(scope.row)">完工
            </el-button>
            <el-button size="mini" type="primary" v-show="scope.row.state === 2"
                       @click="deliveryCar(scope.row)">交车
            </el-button>
            <el-button size="mini" type="primary" v-show="scope.row.state === 1"
                       @click="modifyOrder(scope.row)">修改
            </el-button>
            <el-button size="mini" type="primary" v-show="scope.row.payState === 1"
                       @click="settlementOrder(scope.row)">结算
            </el-button>
            <el-button size="mini" type="primary" v-show="scope.row.state !== 1"
